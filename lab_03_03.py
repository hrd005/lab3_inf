...
# task 10
set3 = frozenset(set1) # set3 is immutable, so we can't modify its objects, add them or remove. 'frozenset' just have no such methods to not allow us to do that
set3.remove("q")
print(set3)
print("\n")